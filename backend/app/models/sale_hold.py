...
class SaleHold(Base):
    ...
    # True when the line was added by scanning the *product* code (not a specific
    # variant/code-unit code). Such lines let the cashier switch coding attributes
    # (e.g. color) across variants; a variant-code scan keeps coding locked.
